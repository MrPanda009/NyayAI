    ...
    <div className="flex min-h-screen bg-gray-50 dark:bg-[#0f1e3f]">
      ...
      <div className="flex-1 max-w-[1200px] mx-auto p-6 md:p-10 text-gray-900 dark:text-white font-serif">
        ...
        <div className="flex flex-wrap gap-4 mb-8 font-sans">
          {/* Law Type Dropdown */}
          <button className="flex items-center gap-3 bg-white dark:bg-[#0f1e3f] border border-gray-300 dark:border-[#cdaa80]/50 text-[#997953] dark:text-[#cdaa80] px-4 py-2.5 rounded-lg hover:bg-gray-50 dark:hover:bg-[#213a56] transition-colors focus:ring-2 focus:ring-[#997953]/30 dark:focus:ring-[#cdaa80]/30 outline-none w-48 shadow-sm">
          ...
          {/* Experience Dropdown */}
          <button className="flex items-center gap-3 bg-white dark:bg-[#0f1e3f] border border-gray-300 dark:border-[#cdaa80]/50 text-[#997953] dark:text-[#cdaa80] px-4 py-2.5 rounded-lg hover:bg-gray-50 dark:hover:bg-[#213a56] transition-colors focus:ring-2 focus:ring-[#997953]/30 dark:focus:ring-[#cdaa80]/30 outline-none w-56 shadow-sm">
            <svg className="w-5 h-5 shrink-0 opacity-80" fill="none" viewBox="0 0 24 24" stroke="currentColor">
